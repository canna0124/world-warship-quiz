...
let modeData = { real: [], kancolle: [], azurlane: [], wows: [], warthunder: [], guns: [], minecraft: [] };
let activePool = [];
let questions = [];
let endlessQueue = [];
let currentIndex = 0;
...
async function loadImage(item){
  ...
  img.classList.remove("wows-lowres","wows-medium","wows-hd","wt-image","gun-image","kancolle-banner-crop","kancolle-card-image","kancolle-full-image","azurlane-image","minecraft-texture");
